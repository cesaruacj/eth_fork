...
const UPDATE_INTERVAL_MS = 0.01 * 60 * 1000; // 30 minutos en milisegundos (0 para una sola ejecución)

// Inicializar proveedor
if (!process.env.RPC_URL) {
  throw new Error("RPC_URL no está definida en el archivo .env");
}
...
// Función principal
async function main() {
  console.log("🔄 Iniciando monitoreo de gas fee en la red Mainnet...");
